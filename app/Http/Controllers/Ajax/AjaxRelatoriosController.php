...
class AjaxRelatoriosController extends Controller
{
    public function OpcoesRelatoriosDefault(\App\Http\Controllers\OwnAuthController $ownauthcontroller, Request $request)
    {
        ...
        } elseif ($request->item == 'voluntarios-aviacao') {
        ...
        } elseif ($request->item == 'escolha-qms') {
            if ($ownauthcontroller->PermissaoCheck(1)) {
        ...
        } elseif ($request->item == 'avaliacoes-ssaa') {
                                                ...
                                                if (is_numeric($keys) && $itens['tfm_abdominal'] == 'N') {
                                                    foreach ($itens['avaliacoes'] as $avaliacoes) {
                                                        if (in_array($avaliacoes->nome_abrev, ['AA', 'AC'])) {
                                                            if (
                                                                $avaliacoes->nome_abrev == $atleta->bonificacao_atleta
                                        ...
                                        foreach ($k[$alunoID][$key] as $key_aval => $avaliacao) {
                                            ...
                                            if (is_numeric($key_aval)) {
                                                ...
                                                *********************************************************/
                                                ...
                                                } elseif (isset($avaliacao['tfm_abdominal']) && $avaliacao['tfm_abdominal'] == 'S') {
    ...
    Log::channel('gaviao')->debug("Teste.", ['avaliacao' => $k[$alunoID]['avaliacoes_tfm']['colspan_demonstrativo'], 'colspan_atleta' => $colspan_atleta, 'teste' => $colspan_demonstrativo]);
                                        ...
                                        *********************************************************/
                                        ...
                                        //ND = média aritmética simples das notas das AR dos teste que obeteve abaixo de 5,000.
                                            ...
                                            $k[$alunoID]['avaliacoes_tfm']['media_tfm_abdominal'] == 'S'
                                            && !is_null($k[$alunoID]['avaliacoes_tfm']['notas_sem_grau_minimo'])
                                    ...
                                    dd($ex, 'aluno_id = ' . $alunoID, $avaliacao);
                                }
