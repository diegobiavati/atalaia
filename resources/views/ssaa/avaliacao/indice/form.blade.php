<style>
    ...
    .container-side {
        ...
        border-radius: 0.25rem;
        padding: 10px;
        border: solid 2px {{ isset($cursoSelecionado) ? App\Http\Controllers\Utilitarios\FuncoesController::getQmsColor($cursoSelecionado->qms_matriz_id)->backgroundColor : '#f00' }};
    }
    ...
    <div class="container-header">
        <div class="row" style="height:105px;">
            ...
            <div class="col-sm" style="text-align:center; height:150px;">
                <div class="col-sm" style="line-height: 3;font-weight: bold;margin-bottom: -16px;margin-top: -15px;">Processo nº</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.container .container-side #btn-lancamento').click(function(evt){
            evt.stopImmediatePropagation(); //Não deixa duplicar os eventos
