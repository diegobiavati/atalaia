            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-implantar-aluno1" role="tabpanel" aria-labelledby="nav-home-tab" style="padding: 20px;">
                    ...
                    <div class="divImplantarAluno" style="border-bottom:none; width: 20%;">
                        ...
                        <select {{ ($ownauthcontroller->PermissaoCheck(1) ? '': 'disabled') }} class="custom-select" id="ano_formacao" name="ano_formacao" style="margin-top:5px;" onchange="$('select#data_matricula').val( $(this).val() );" {{ ( (session()->get('login.qmsID') == null) ? '' : 'readonly') }}>
