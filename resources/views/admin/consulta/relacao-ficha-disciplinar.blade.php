<form id="ficha-relatorio">
    ...
    <div style="margin-top: 24px;">
        <button id="btn-frad-geral" type="button" class="btn btn-primary" onclick="abrirDisciplinarGeral('{{route($rotaGeral)}}', '{{$idOmct}}', '{{$anoFormacao->id}}');">Visualizar FRAD (Geral)</button>
    </div>
</form>
<script>
    ...
    function abrirDisciplinarGeral(rota, idOmct, idAnoFormacao) {
