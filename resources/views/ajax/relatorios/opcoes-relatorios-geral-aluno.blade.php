...
@switch($requisicao)
  ...
  @case('avaliacoes'):
        <ul class="list-group list-group-flush" style="margin-top: 44px;">
          ...
          <li class="list-group-item opcoes-relatorios"><a href="javascript: void(0);" class="no-style" onclick="loadRelatorioAjaxContent('ssaa/avaliacoes-recuperacao');">Aluno(s) em Recuperação</a></li>
        </ul>
  @break
